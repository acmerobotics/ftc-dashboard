...
import com.acmerobotics.dashboard.TestFieldOriginOpMode;

import java.util.Arrays;
import java.util.List;

public class TestOpModeManager {
    private final List<TestOpMode> testOpModes = Arrays.asList(new TestSineWaveOpMode(), new TestFieldOriginOpMode());
