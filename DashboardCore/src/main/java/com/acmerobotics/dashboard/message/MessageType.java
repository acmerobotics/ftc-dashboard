...
import com.acmerobotics.dashboard.message.redux.GetHardware;
...
public enum MessageType {
    ...
    /* hardware */
    GET_HARDWARE(GetHardware.class),
    SAVE_HARDWARE(SaveHardware.class),
    RECEIVE_HARDWARE(ReceiveHardware.class),
